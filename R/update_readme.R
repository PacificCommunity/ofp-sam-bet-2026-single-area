...
defaults <- data.frame(
  ...
  value = c(
    ...
    tryCatch(kflow$env$STEPWISE_SAVE_RAW_MFCL_INPUTS, error = function(e) "true"),
  ...
  meaning = c(
    ...
    "Kflow group label used to connect model, results, and report jobs.",
