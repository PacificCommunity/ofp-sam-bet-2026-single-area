...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| `01-SingleArea` | `TRUE` | 01-SingleArea | 01a | single-area BET short MFCL run from fitted checkpoint | Single-area checkpoint | 01 Single-area checkpoint | `01-single-area-checkpoint` | `single_par` | blank | `09.par` | `bet.frq` | `final.par` |
