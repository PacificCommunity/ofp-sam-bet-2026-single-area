...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| `01-SingleArea` | `TRUE` | 01-SingleArea | 01a | single-area BET model from provided input bundle | Single-area | 01 Single-area | `01-single-area` | `doitall` | blank | `blank` | `bet.frq` | `blank` |
